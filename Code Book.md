...
(https://d396qusza40orc.cloudfront.net/getdata%2Fprojectfiles%2FUCI%20HAR%20Dataset.zip )
        ...
        Check for txt files in working directory with:  getwd() which returns:
[1] "activity_labels.txt"  [2] "features.txt" ##  [7] "subject_test.txt"                   [8] "subject_train.txt"    [10] "X_test.txt"      [11] "X_train.txt"                 
